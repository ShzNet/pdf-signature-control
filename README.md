...
- **3 Publishable Packages** - Ready for NPM publishing
  ...
  - `@shz/strings` - String manipulation utilities
  - `@shz/async` - Async utility functions with retry logic
  - `@shz/colors` - Color conversion and manipulation utilities

- **1 Internal Library**
  - `@shz/utils` - Shared utilities (private, not published)
...
| -------------- | --------------- | ---------------------- |
| `@shz/utils`   | `scope:shared`  | Nothing (base library) |
| `@shz/strings` | `scope:strings` | `scope:shared`         |
| `@shz/async`   | `scope:async`   | `scope:shared`         |
| `@shz/colors`  | `scope:colors`  | `scope:shared`         |
...
1. Try importing `@shz/colors` into `@shz/strings`
